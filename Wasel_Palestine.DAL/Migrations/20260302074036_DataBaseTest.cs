        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AlertSubscriptions_IncidentCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DuplicateOfReportId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_IncidentCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "IncidentCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reports_Reports_DuplicateOfReportId",
                        column: x => x.DuplicateOfReportId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvoidCheckpoints = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RouteRequests_Locations_FromLocationId",
                        column: x => x.FromLocationId,
                        principalTable: "Locations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RouteRequests_Locations_ToLocationId",
                        column: x => x.ToLocationId,
                        principalTable: "Locations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RouteRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckpointStatusHistories", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CheckpointStatusHistories_Users_ChangedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReportMedias_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportModerationActions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReportModerationActions_Reports_ReportId",
                        column: x => x.ReportId,
                        principalTable: "Reports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReportModerationActions_Users_ModeratorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IncidentHistories_IncidentStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "IncidentStatuses",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlertRecipients_UserId",
                table: "AlertRecipients",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlertSubscriptions_CategoryId",
                table: "AlertSubscriptions",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AlertSubscriptions_LocationId",
                table: "AlertSubscriptions",
                column: "LocationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckpointStatusHistories_ChangedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportMedias_UserId",
                table: "ReportMedias",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportModerationActions_ModeratorId",
                table: "ReportModerationActions",
                column: "ModeratorId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportModerationActions_ReportId",
                table: "ReportModerationActions",
                column: "ReportId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_DuplicateOfReportId",
                table: "Reports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RouteRequests_FromLocationId",
                table: "RouteRequests",
                column: "FromLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_RouteRequests_ToLocationId",
                table: "RouteRequests",
                column: "ToLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_RouteRequests_UserId",
                table: "RouteRequests",
                column: "UserId");
